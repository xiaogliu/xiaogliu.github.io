...
解决回调地狱的异步操作，Async 函数是终极办法，但了解生成器和 Promise 有助于理解 Async 函数原理。由于内容较多，分三部分进行，这是第三部分，介绍 Async 函数相关。[第一部分介绍 Generator](https://xiaogliu.github.io/2018/07/22/from-generator-to-promise-to-async-1)，[第二部分介绍 Promise](https://xiaogliu.github.io/2018/07/22/from-generator-to-promise-to-async-2)。
