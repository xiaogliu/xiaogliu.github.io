...
解决回调地狱的异步操作，Async 函数是终极办法，但了解生成器和 Promise 有助于理解 Async 函数原理。由于内容较多，分三部分进行，这是第一部分，介绍生成器相关，[第二部分](https://xiaogliu.github.io/2018/07/22/from-generator-to-promise-to-async-2)介绍 Promise，[第三部分](https://xiaogliu.github.io/2018/07/22/from-generator-to-promise-to-async-3)介绍 Async 函数。
